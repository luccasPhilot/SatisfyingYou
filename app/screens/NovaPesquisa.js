  ...
  return (
    <View style={[styles.fundo]}>
      ...
      <View style={[styles.viewRowTitle]}>
        ...
        <Text style={[styles.textTitle]}>Nova Pesquisa</Text>
      </View>
      ...
      <View style={[styles.viewInput]}>
        ...
        <InputImage textoTopo ="Imagem" corFundo="white" corTexto="#939393" 
        fonteTexto="AveriaLibre-Regular" corTextoTopo="white" tamanhoTextoTopo={20} textoInterno="Câmera/Galeria de imagens">
        </InputImage>
      </View>
